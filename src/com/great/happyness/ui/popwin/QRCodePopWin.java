package com.great.happyness.ui.popwin;

import com.great.happyness.wifimain.R;
import com.great.happyness.ui.qrcode.QRCodeUtil;
...
public class QRCodePopWin extends PopupWindow {
	...
	public void createQR(Context context, int psType, String ssid, int width, int height) {
		try {
				String qrcode = "http://www.greatwit.com?"+"hps="+psType+"&sid="+ssid+"&psw:="+SysConfig.WIFI_AP_KEY;
				Bitmap bitmap = QRCodeUtil.createQRImage(qrcode, width, height,
