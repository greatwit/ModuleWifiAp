		...
		public void handleMessage(Message msg)
		{
			switch(msg.what)
			{
				case MESSAGE_CREATE_BEGIN:
					...
					int psType = WifiUtils.WIFICIPHER_NOPASS;
					if(mWifiUtils.isWifiApEnabled())//判断热点是否打开
					{
		            	...
		            	mQrcodePopWin.createQR(CreateWifiActivity.this, psType, SysConfig.WIFI_AP_SSID, pw-50, ph-50);
		            	mTasksView.setProgress(100);
					}
					else
					{
						if(mWifiUtils.createWifiHotspot(psType, 
								SysConfig.WIFI_AP_SSID, SysConfig.WIFI_AP_KEY))
						{
			            	...
			            	if(mQrcodePopWin==null)
			            	{
			            		...
			            		if(!isFinishing()) {
			            			mQrcodePopWin.showAtLocation(findViewById(R.id.main_view), Gravity.CENTER, 0, 0);
			            			mQrcodePopWin.createQR(CreateWifiActivity.this, psType,
			            				SysConfig.WIFI_AP_SSID, pw-20, ph-20);
			            		}
			            	}
			        		mTasksView.setProgress(100);
						}
