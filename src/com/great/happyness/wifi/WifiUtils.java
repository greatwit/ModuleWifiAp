...
{  
    ...
    public int wifiConnect(String wssid, String pass, int type)
    {
...
//            }
//        } 
    	WifiConfiguration config = createWifiInfo(wssid, pass, type);
    ...
    {
        Log.w("AAA", "SSID = " + ssid + "password " + password + "type =" + type);
    ...
    public boolean createWifiHotspot(int type, String ssid, String key) {
    	boolean bRes = false;
    	WifiConfiguration config = createWifiInfo(ssid, key, type);
        //通过反射调用设置热点
        try {
            Method method = mWifiManager.getClass().getMethod(
                    "setWifiApEnabled", WifiConfiguration.class, Boolean.TYPE);
            bRes = (Boolean) method.invoke(mWifiManager, config, true);
        } catch (Exception e) {
            e.printStackTrace();
        }
    	return bRes;
